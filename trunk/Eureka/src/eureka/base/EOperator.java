...
/**Enumerao que especifica os operadores que podem ser usados pelas clusulas nas regras*/
public enum EOperator {
	EQUALS("="), NOT_EQUALS("!="), GREATHER_THAN(">"), LESS_THAN("<"), GREATER_OR_EQUAL(">="), LESS_OR_EQUAL("<="), RECEIVE ("<-");
	
	private static EOperator[] operators = {EQUALS, NOT_EQUALS, GREATHER_THAN, LESS_THAN, GREATER_OR_EQUAL, LESS_OR_EQUAL, RECEIVE};
